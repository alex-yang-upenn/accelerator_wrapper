set moduleName dense_array_ap_ufixed_32u_array_ap_fixed_16_6_5_3_0_5u_config11_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dense<array<ap_ufixed,32u>,array<ap_fixed<16,6,5,3,0>,5u>,config11>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer10_out int 192 regular {fifo 0 volatile }  }
	{ layer11_out int 80 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer10_out", "interface" : "fifo", "bitwidth" : 192, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer10_out_dout sc_in sc_lv 192 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer10_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":192, "type": "signal", "bundle":{"name": "layer10_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer10_out { ap_fifo {  { layer10_out_dout fifo_port_we 0 192 }  { layer10_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer10_out_fifo_cap fifo_update 0 2 }  { layer10_out_empty_n fifo_status 0 1 }  { layer10_out_read fifo_data 1 1 } } }
	layer11_out { ap_fifo {  { layer11_out_din fifo_port_we 1 80 }  { layer11_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer11_out_fifo_cap fifo_update 0 2 }  { layer11_out_full_n fifo_status 0 1 }  { layer11_out_write fifo_data 1 1 } } }
}
