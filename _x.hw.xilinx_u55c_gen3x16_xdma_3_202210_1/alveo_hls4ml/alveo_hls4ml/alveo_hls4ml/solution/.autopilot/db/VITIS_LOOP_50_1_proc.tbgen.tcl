set moduleName VITIS_LOOP_50_1_proc
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {VITIS_LOOP_50_1_proc}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_r int 64 regular  }
	{ gmem0 int 16 regular {axi_master 0}  }
	{ in_buf_V int 288 regular {array 16384 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_r", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in_buf_V", "interface" : "memory", "bitwidth" : 288, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_buf_V_address0 sc_out sc_lv 14 signal 2 } 
	{ in_buf_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ in_buf_V_we0 sc_out sc_logic 1 signal 2 } 
	{ in_buf_V_d0 sc_out sc_lv 288 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_buf_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "in_buf_V", "role": "address0" }} , 
 	...
 	{ "name": "in_buf_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":288, "type": "signal", "bundle":{"name": "in_buf_V", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "294986", "EstimateLatencyMax" : "294986",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_50_1_proc_Pipeline_VITIS_LOOP_50_1_fu_51", "Port" : "gmem0", "Inst_start_state" : "71", "Inst_end_state" : "72"}]},
			{"Name" : "in_buf_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_50_1_proc_Pipeline_VITIS_LOOP_50_1_fu_51", "Port" : "in_buf_V", "Inst_start_state" : "71", "Inst_end_state" : "72"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_VITIS_LOOP_50_1_proc_Pipeline_VITIS_LOOP_50_1_fu_51", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "VITIS_LOOP_50_1_proc_Pipeline_VITIS_LOOP_50_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "294915", "EstimateLatencyMax" : "294915",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_VITIS_LOOP_50_1_proc_Pipeline_VITIS_LOOP_50_1_fu_51.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set ArgLastReadFirstWriteLatency {
	VITIS_LOOP_50_1_proc {
		...
		in_buf_V {Type O LastRead -1 FirstWrite 19}}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "294986", "Max" : "294986"}
	, {"Name" : "Interval", "Min" : "294986", "Max" : "294986"}
]}
...
set Spec2ImplPortList { 
	...
	in_buf_V { ap_memory {  { in_buf_V_address0 mem_address 1 14 }  { in_buf_V_ce0 mem_ce 1 1 }  { in_buf_V_we0 mem_we 1 1 }  { in_buf_V_d0 mem_din 1 288 } } }
}
