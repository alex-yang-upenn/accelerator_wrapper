...
set C_modelArgList {
	...
	{ in_buf_V int 256 regular {array 8192 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_r", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in_buf_V", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_buf_V_address0 sc_out sc_lv 13 signal 2 } 
	{ in_buf_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ in_buf_V_we0 sc_out sc_logic 1 signal 2 } 
	{ in_buf_V_d0 sc_out sc_lv 256 signal 2 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "131146", "Max" : "131146"}
	, {"Name" : "Interval", "Min" : "131146", "Max" : "131146"}
]}
...
set Spec2ImplPortList { 
	...
	in_buf_V { ap_memory {  { in_buf_V_address0 mem_address 1 13 }  { in_buf_V_ce0 mem_ce 1 1 }  { in_buf_V_we0 mem_we 1 1 }  { in_buf_V_d0 mem_din 1 256 } } }
}
