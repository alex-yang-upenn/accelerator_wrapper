...
# 47 "/home/ayvol/accelerator_wrapper/src/defines.h"
...
# 74 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.h"
...
# 46 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp"
static void read_input(const input_data_t *in, hls::stream<input_stream_t> &input, int n) {
  VITIS_LOOP_47_1: for (int i = 0; i < (8); i++) {
#pragma HLS PIPELINE
 input_stream_t tmp;
    VITIS_LOOP_50_2: for (int j = 0; j < 1; j++) {
#pragma HLS UNROLL
 tmp[j] = in[(n * (8) * 1) + (i * 1) + j];
    }
    input << tmp;
  }
}
static void write_result(output_data_t *out, hls::stream<output_stream_t> &output, int n) {
  ...
  VITIS_LOOP_59_1: for (int i = 0; i < 1; i++) {
#pragma HLS UNROLL
 out[(n * 1) + i] = tmp[i];
  }
}
# 89 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp"
extern "C" {
...
# 95 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp"

# 112 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp"
      hls::stream<input_stream_t> input("input");
      hls::stream<output_stream_t> output("output");
#pragma HLS STREAM variable=input depth=(8)
#pragma HLS STREAM variable=output depth=1

 VITIS_LOOP_117_1: for (int n = 0; n < 8192; n++) {
#pragma HLS DATAFLOW
