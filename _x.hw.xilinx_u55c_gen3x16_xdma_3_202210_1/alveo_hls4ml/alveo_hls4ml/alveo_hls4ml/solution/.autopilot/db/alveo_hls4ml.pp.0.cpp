# 1 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 361 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp" 2
# 1 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.h" 1
# 39 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.h"
# 1 "/home/ayvol/accelerator_wrapper/src/defines.h" 1
...
# 5 "/home/ayvol/accelerator_wrapper/src/defines.h" 2
# 1 "/tools/Xilinx/Vitis_HLS/2022.2/common/technology/autopilot/ap_int.h" 1
# 6 "/home/ayvol/accelerator_wrapper/src/defines.h" 2
# 1 "/home/ayvol/accelerator_wrapper/src/nnet_utils/nnet_types.h" 1
...
# 5 "/home/ayvol/accelerator_wrapper/src/nnet_utils/nnet_types.h" 2
...
# 6 "/home/ayvol/accelerator_wrapper/src/nnet_utils/nnet_types.h" 2
...
# 7 "/home/ayvol/accelerator_wrapper/src/nnet_utils/nnet_types.h" 2
...
# 7 "/home/ayvol/accelerator_wrapper/src/defines.h" 2

# 1 "/tools/Xilinx/Vitis_HLS/2022.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstdio" 1 3
# 40 "/tools/Xilinx/Vitis_HLS/2022.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstdio" 3
# 9 "/home/ayvol/accelerator_wrapper/src/defines.h" 2
# 41 "/home/ayvol/accelerator_wrapper/src/defines.h"
...
typedef ap_ufixed<6,0,AP_RND_CONV,AP_SAT> layer12_t;
...
typedef ap_ufixed<6,0,AP_RND_CONV,AP_SAT> layer18_t;
...
typedef ap_ufixed<6,0,AP_RND_CONV,AP_SAT> layer22_t;
...
# 1 "/home/ayvol/accelerator_wrapper/src/myproject.h" 1




# 1 "/tools/Xilinx/Vitis_HLS/2022.2/common/technology/autopilot/ap_int.h" 1
# 6 "/home/ayvol/accelerator_wrapper/src/myproject.h" 2
...
# 7 "/home/ayvol/accelerator_wrapper/src/myproject.h" 2
...
void myproject(
    input_t input_2[8*1],
    result_t layer23_out[1]
);
# 5 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp" 2


static void read_input(const input_data_t *in, input_data_t (&in_buf)[8192][(8 * 1)]) {
  VITIS_LOOP_8_1: for (int i = 0; i < 8192; i++) {
#pragma HLS PIPELINE
 VITIS_LOOP_10_2: for(int j = 0; j < (8 * 1); j++) {
#pragma HLS UNROLL
 in_buf[i][j] = in[i * (8 * 1) + j];
      }
    }
}
static void run_inference(input_data_t (&in_buf)[8192][(8 * 1)], output_data_t (&out_buf)[8192][1]) {
  VITIS_LOOP_17_1: for (int i = 0; i < 8192; i++) {
#pragma HLS DATAFLOW
 hls4ml: myproject(in_buf[i],out_buf[i]);
    }
}
static void write_result(output_data_t *out, output_data_t (&out_buf)[8192][1]) {
  VITIS_LOOP_23_1: for (int i = 0; i < 8192; i++) {
#pragma HLS PIPELINE
 VITIS_LOOP_25_2: for (int j = 0; j < 1; j++) {
#pragma HLS UNROLL
 out[i * 1 + j] = out_buf[i][j];
    }
  }
}
...
# 102 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp"
      ...
      input_data_t in_buf[8192][(8 * 1)];
      output_data_t out_buf[8192][1];
