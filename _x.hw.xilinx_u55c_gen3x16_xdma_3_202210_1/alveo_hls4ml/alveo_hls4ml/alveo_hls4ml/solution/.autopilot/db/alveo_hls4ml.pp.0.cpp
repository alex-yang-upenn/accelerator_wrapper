...
# 22 "/home/ayvol/accelerator_wrapper/src/defines.h"
...
# 73 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.h"
...
# 43 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp"
static void read_input(const input_data_t *in, hls::stream<input_stream_t> &input, int n) {
  input_stream_t tmp;
  VITIS_LOOP_45_1: for (int i = 0; i < 16; i++) {
#pragma HLS UNROLL
 tmp[i] = in[(n * 16) + i];
  }
  input << tmp;
...
static void write_result(output_data_t *out, hls::stream<output_stream_t> &output, int n) {
  ...
  VITIS_LOOP_53_1: for (int i = 0; i < 5; i++) {
#pragma HLS UNROLL
 out[(n * 5) + i] = tmp[i];
  }
}
# 104 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp"
extern "C" {
...
# 110 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp"

# 124 "/home/ayvol/accelerator_wrapper/src/alveo_hls4ml.cpp"
      hls::stream<input_stream_t> input("input");
      hls::stream<output_stream_t> output("output");
#pragma HLS STREAM variable=input depth=1
#pragma HLS STREAM variable=output depth=1

 VITIS_LOOP_129_1: for (int n = 0; n < 8192; n++) {
#pragma HLS DATAFLOW
