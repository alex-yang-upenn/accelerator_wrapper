set moduleName dense_latency_ap_ufixed_6_0_4_0_0_ap_fixed_16_6_5_3_0_config23_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dense_latency<ap_ufixed<6, 0, 4, 0, 0>, ap_fixed<16, 6, 5, 3, 0>, config23>}
...
set portList { 
	...
	{ i_dout sc_in sc_lv 13 signal 17 } 
	{ i_num_data_valid sc_in sc_lv 6 signal 17 } 
	{ i_fifo_cap sc_in sc_lv 6 signal 17 } 
	{ i_empty_n sc_in sc_logic 1 signal 17 } 
	{ i_read sc_out sc_logic 1 signal 17 } 
	...
	{ out_buf_address0 sc_out sc_lv 13 signal 16 } 
	{ out_buf_ce0 sc_out sc_logic 1 signal 16 } 
	{ out_buf_we0 sc_out sc_logic 1 signal 16 } 
	{ out_buf_d0 sc_out sc_lv 15 signal 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "i_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "i", "role": "num_data_valid" }} , 
 	{ "name": "i_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "i", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "i", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "18", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	out_buf { ap_memory {  { out_buf_address0 mem_address 1 13 }  { out_buf_ce0 mem_ce 1 1 }  { out_buf_we0 mem_we 1 1 }  { out_buf_d0 mem_din 1 15 } } }
	i { ap_fifo {  { i_dout fifo_port_we 0 13 }  { i_num_data_valid fifo_status_num_data_valid 0 6 }  { i_fifo_cap fifo_update 0 6 }  { i_empty_n fifo_status 0 1 }  { i_read fifo_data 1 1 } } }
}
