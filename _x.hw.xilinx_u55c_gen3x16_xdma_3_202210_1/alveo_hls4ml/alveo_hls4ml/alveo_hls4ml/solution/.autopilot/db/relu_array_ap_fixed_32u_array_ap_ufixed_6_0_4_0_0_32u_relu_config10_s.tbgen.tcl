set moduleName relu_array_ap_fixed_32u_array_ap_ufixed_6_0_4_0_0_32u_relu_config10_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {relu<array<ap_fixed,32u>,array<ap_ufixed<6,0,4,0,0>,32u>,relu_config10>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer8_out int 512 regular {fifo 0 volatile }  }
	{ layer10_out int 192 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer8_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "layer10_out", "interface" : "fifo", "bitwidth" : 192, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer8_out_dout sc_in sc_lv 512 signal 0 } 
	...
	{ layer10_out_din sc_out sc_lv 192 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer8_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "layer8_out", "role": "dout" }} , 
 	...
 	{ "name": "layer10_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":192, "type": "signal", "bundle":{"name": "layer10_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer8_out { ap_fifo {  { layer8_out_dout fifo_port_we 0 512 }  { layer8_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer8_out_fifo_cap fifo_update 0 2 }  { layer8_out_empty_n fifo_status 0 1 }  { layer8_out_read fifo_data 1 1 } } }
	layer10_out { ap_fifo {  { layer10_out_din fifo_port_we 1 192 }  { layer10_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer10_out_fifo_cap fifo_update 0 2 }  { layer10_out_full_n fifo_status 0 1 }  { layer10_out_write fifo_data 1 1 } } }
}
