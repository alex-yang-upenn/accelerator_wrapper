...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer10_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer10_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer12_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer10_out { ap_fifo {  { layer10_out_dout fifo_port_we 0 384 }  { layer10_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer10_out_fifo_cap fifo_update 0 2 }  { layer10_out_empty_n fifo_status 0 1 }  { layer10_out_read fifo_data 1 1 } } }
	layer12_out { ap_fifo {  { layer12_out_din fifo_port_we 1 144 }  { layer12_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer12_out_fifo_cap fifo_update 0 2 }  { layer12_out_full_n fifo_status 0 1 }  { layer12_out_write fifo_data 1 1 } } }
}
