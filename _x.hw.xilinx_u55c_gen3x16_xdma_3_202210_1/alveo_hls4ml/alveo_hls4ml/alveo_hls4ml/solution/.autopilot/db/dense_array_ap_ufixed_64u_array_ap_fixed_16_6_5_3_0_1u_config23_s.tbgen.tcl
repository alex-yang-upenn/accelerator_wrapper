set moduleName dense_array_ap_ufixed_64u_array_ap_fixed_16_6_5_3_0_1u_config23_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dense<array<ap_ufixed,64u>,array<ap_fixed<16,6,5,3,0>,1u>,config23>}
...
set Spec2ImplPortList { 
	...
	output_r { ap_fifo {  { output_r_din fifo_port_we 1 16 }  { output_r_num_data_valid fifo_status_num_data_valid 0 2 }  { output_r_fifo_cap fifo_update 0 2 }  { output_r_full_n fifo_status 0 1 }  { output_r_write fifo_data 1 1 } } }
}
