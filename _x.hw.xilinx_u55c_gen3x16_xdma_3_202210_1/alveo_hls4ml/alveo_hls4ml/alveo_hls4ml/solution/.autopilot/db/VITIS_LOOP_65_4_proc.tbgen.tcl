...
set C_modelArgList {
	...
	{ out_buf_V int 16 regular {array 16384 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ out_buf_V_address0 sc_out sc_lv 14 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_buf_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "out_buf_V", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_65_4_proc_Pipeline_VITIS_LOOP_65_4_fu_62", "Port" : "gmem1", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "out_buf_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_65_4_proc_Pipeline_VITIS_LOOP_65_4_fu_62", "Port" : "out_buf_V", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_VITIS_LOOP_65_4_proc_Pipeline_VITIS_LOOP_65_4_fu_62", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_VITIS_LOOP_65_4_proc_Pipeline_VITIS_LOOP_65_4_fu_62.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	out_buf_V { ap_memory {  { out_buf_V_address0 mem_address 1 14 }  { out_buf_V_ce0 mem_ce 1 1 }  { out_buf_V_q0 mem_dout 0 16 } } }
}
