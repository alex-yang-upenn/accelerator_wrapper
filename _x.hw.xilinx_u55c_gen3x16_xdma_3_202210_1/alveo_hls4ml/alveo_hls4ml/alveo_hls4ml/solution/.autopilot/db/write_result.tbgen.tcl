...
set C_modelArgList {
	...
	{ out_buf_0 int 13 regular {array 8192 { 1 3 } 1 1 }  }
	{ out_buf_1 int 13 regular {array 8192 { 1 3 } 1 1 }  }
	{ out_buf_2 int 13 regular {array 8192 { 1 3 } 1 1 }  }
	{ out_buf_3 int 13 regular {array 8192 { 1 3 } 1 1 }  }
	{ out_buf_4 int 13 regular {array 8192 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "out_buf_0", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "out_buf_1", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "out_buf_2", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "out_buf_3", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "out_buf_4", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_result_Pipeline_VITIS_LOOP_23_1_fu_70", "Port" : "gmem1", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "out_buf_0", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_result_Pipeline_VITIS_LOOP_23_1_fu_70", "Port" : "out_buf_0", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "out_buf_1", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_result_Pipeline_VITIS_LOOP_23_1_fu_70", "Port" : "out_buf_1", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "out_buf_2", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_result_Pipeline_VITIS_LOOP_23_1_fu_70", "Port" : "out_buf_2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "out_buf_3", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_result_Pipeline_VITIS_LOOP_23_1_fu_70", "Port" : "out_buf_3", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "out_buf_4", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_result_Pipeline_VITIS_LOOP_23_1_fu_70", "Port" : "out_buf_4", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_result_Pipeline_VITIS_LOOP_23_1_fu_70", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_result_Pipeline_VITIS_LOOP_23_1_fu_70.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	out_buf_0 { ap_memory {  { out_buf_0_address0 mem_address 1 13 }  { out_buf_0_ce0 mem_ce 1 1 }  { out_buf_0_q0 mem_dout 0 13 } } }
	out_buf_1 { ap_memory {  { out_buf_1_address0 mem_address 1 13 }  { out_buf_1_ce0 mem_ce 1 1 }  { out_buf_1_q0 mem_dout 0 13 } } }
	out_buf_2 { ap_memory {  { out_buf_2_address0 mem_address 1 13 }  { out_buf_2_ce0 mem_ce 1 1 }  { out_buf_2_q0 mem_dout 0 13 } } }
	out_buf_3 { ap_memory {  { out_buf_3_address0 mem_address 1 13 }  { out_buf_3_ce0 mem_ce 1 1 }  { out_buf_3_q0 mem_dout 0 13 } } }
	out_buf_4 { ap_memory {  { out_buf_4_address0 mem_address 1 13 }  { out_buf_4_ce0 mem_ce 1 1 }  { out_buf_4_q0 mem_dout 0 13 } } }
}
