...
set C_modelArgList {
	...
	{ output_r int 80 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "output_r", "interface" : "fifo", "bitwidth" : 80, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ output_r_dout sc_in sc_lv 80 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_r_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":80, "type": "signal", "bundle":{"name": "output_r", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	output_r { ap_fifo {  { output_r_dout fifo_port_we 0 80 }  { output_r_num_data_valid fifo_status_num_data_valid 0 2 }  { output_r_fifo_cap fifo_update 0 2 }  { output_r_empty_n fifo_status 0 1 }  { output_r_read fifo_data 1 1 } } }
