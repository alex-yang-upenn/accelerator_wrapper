...
set C_modelArgList {
	...
	{ out_buf int 15 regular {array 8192 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "out_buf", "interface" : "memory", "bitwidth" : 15, "direction" : "READONLY"} ]}
...
set Spec2ImplPortList { 
	...
	out_buf { ap_memory {  { out_buf_address0 mem_address 1 13 }  { out_buf_ce0 mem_ce 1 1 }  { out_buf_q0 mem_dout 0 15 } } }
}
