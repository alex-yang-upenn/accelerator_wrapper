...
set C_modelArgList {
	...
	{ in_r int 64 regular  }
	{ in_buf int 768 regular {array 8192 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "in_buf", "interface" : "memory", "bitwidth" : 768, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_buf_d0 sc_out sc_lv 768 signal 2 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "24650", "Max" : "24650"}
	, {"Name" : "Interval", "Min" : "24650", "Max" : "24650"}
]}
...
set Spec2ImplPortList { 
	...
	in_buf { ap_memory {  { in_buf_address0 mem_address 1 13 }  { in_buf_ce0 mem_ce 1 1 }  { in_buf_we0 mem_we 1 1 }  { in_buf_d0 mem_din 1 768 } } }
}
