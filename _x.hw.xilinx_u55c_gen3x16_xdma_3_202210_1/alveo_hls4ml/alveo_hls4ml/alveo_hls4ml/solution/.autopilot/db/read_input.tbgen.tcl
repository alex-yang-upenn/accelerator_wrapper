...
set portList { 
	...
	{ input1_din sc_out sc_lv 16 signal 2 } 
	{ input1_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ input1_fifo_cap sc_in sc_lv 4 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "input1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96", "Port" : "input1", "Inst_start_state" : "73", "Inst_end_state" : "74"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
