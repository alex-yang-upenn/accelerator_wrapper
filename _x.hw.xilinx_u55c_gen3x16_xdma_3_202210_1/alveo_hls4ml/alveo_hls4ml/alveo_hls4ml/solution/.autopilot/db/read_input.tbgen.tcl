...
set C_modelArgList {
	...
	{ in_r int 64 regular  }
	{ input1 int 256 regular {fifo 1 volatile }  }
	{ n int 13 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "input1", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ input1_din sc_out sc_lv 256 signal 2 } 
	{ input1_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ input1_fifo_cap sc_in sc_lv 2 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "input1", "role": "din" }} , 
 	{ "name": "input1_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "input1", "role": "num_data_valid" }} , 
 	{ "name": "input1_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "input1", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "input1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0"], "DependentChan" : "0", "DependentChanDepth" : "1", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	input1 { ap_fifo {  { input1_din fifo_port_we 1 256 }  { input1_num_data_valid fifo_status_num_data_valid 0 2 }  { input1_fifo_cap fifo_update 0 2 }  { input1_full_n fifo_status 0 1 }  { input1_write fifo_data 1 1 } } }
