...
entity alveo_hls4ml_fifo_w48_d1024_A is
    generic (
...
architecture arch of alveo_hls4ml_fifo_w48_d1024_A is

    -- component
    component alveo_hls4ml_fifo_w48_d1024_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_alveo_hls4ml_fifo_w48_d1024_A_ram : alveo_hls4ml_fifo_w48_d1024_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity alveo_hls4ml_fifo_w48_d1024_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 48;
        ADDR_WIDTH  : integer := 10;
...
architecture arch of alveo_hls4ml_fifo_w48_d1024_A_ram is
