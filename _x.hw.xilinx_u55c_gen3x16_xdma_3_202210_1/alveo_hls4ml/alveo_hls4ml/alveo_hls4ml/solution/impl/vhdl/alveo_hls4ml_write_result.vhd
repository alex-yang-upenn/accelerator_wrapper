...
attribute shreg_extract : string;
    ...
    signal output_read_reg_132 : STD_LOGIC_VECTOR (15 downto 0);
    signal gmem1_addr_reg_137 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln61_fu_122_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal shl_ln_fu_94_p3 : STD_LOGIC_VECTOR (13 downto 0);
    signal zext_ln61_fu_102_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln61_fu_106_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln_fu_112_p4 : STD_LOGIC_VECTOR (62 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                gmem1_addr_reg_137 <= sext_ln61_fu_122_p1;
                output_read_reg_132 <= output_r_dout;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem1_AWREADY, m_axi_gmem1_WREADY, m_axi_gmem1_BVALID, out_r_empty_n, output_r_empty_n, n_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state71)
    begin
        case ap_CS_fsm is
    ...
    add_ln61_fu_106_p2 <= std_logic_vector(unsigned(out_r_dout) + unsigned(zext_ln61_fu_102_p1));
    ...
    m_axi_gmem1_AWADDR <= gmem1_addr_reg_137;
    ...
    m_axi_gmem1_WDATA <= output_read_reg_132;
    ...
    begin
        ...
        sext_ln61_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_112_p4),64));

    shl_ln_fu_94_p3 <= (n_dout & ap_const_lv1_0);
    trunc_ln_fu_112_p4 <= add_ln61_fu_106_p2(63 downto 1);
    zext_ln61_fu_102_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln_fu_94_p3),64));
end behav;
