...
entity alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_129_1 is
port (
...
architecture behav of alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_129_1 is 
...
attribute shreg_extract : string;
    ...
    signal read_input_U0_input1_din : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal myproject_U0_output_r_din : STD_LOGIC_VECTOR (79 downto 0);
    ...
    signal input1_dout : STD_LOGIC_VECTOR (255 downto 0);
    signal input1_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal input1_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal output2_dout : STD_LOGIC_VECTOR (79 downto 0);
    ...
    component alveo_hls4ml_fifo_w256_d1_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component alveo_hls4ml_fifo_w13_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component alveo_hls4ml_fifo_w80_d1_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component alveo_hls4ml_start_for_write_result_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component alveo_hls4ml_start_for_myproject_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    input1_U : component alveo_hls4ml_fifo_w256_d1_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    n_c_U : component alveo_hls4ml_fifo_w13_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    output2_U : component alveo_hls4ml_fifo_w80_d1_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_write_result_U0_U : component alveo_hls4ml_start_for_write_result_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_myproject_U0_U : component alveo_hls4ml_start_for_myproject_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
