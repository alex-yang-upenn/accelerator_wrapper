...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    signal read_input_U0_in_buf_d0 : STD_LOGIC_VECTOR (287 downto 0);
    signal run_inference_U0_in_buf_address0 : STD_LOGIC_VECTOR (13 downto 0);
    signal run_inference_U0_in_buf_ce0 : STD_LOGIC;
    signal run_inference_U0_in_buf_d0 : STD_LOGIC_VECTOR (287 downto 0);
    ...
    signal run_inference_U0_in_buf_d1 : STD_LOGIC_VECTOR (287 downto 0);
    signal run_inference_U0_in_buf_we1 : STD_LOGIC;
    signal run_inference_U0_out_buf_address0 : STD_LOGIC_VECTOR (13 downto 0);
    signal run_inference_U0_out_buf_ce0 : STD_LOGIC;
    signal run_inference_U0_out_buf_d0 : STD_LOGIC_VECTOR (15 downto 0);
    signal run_inference_U0_out_buf_we0 : STD_LOGIC;
    signal run_inference_U0_out_buf_address1 : STD_LOGIC_VECTOR (13 downto 0);
    signal run_inference_U0_out_buf_ce1 : STD_LOGIC;
    signal run_inference_U0_out_buf_d1 : STD_LOGIC_VECTOR (15 downto 0);
    signal run_inference_U0_out_buf_we1 : STD_LOGIC;
    signal run_inference_U0_in_buf_read : STD_LOGIC;
    signal run_inference_U0_out_buf_full_n : STD_LOGIC;
    signal run_inference_U0_out_buf_write : STD_LOGIC;
    ...
    signal write_result_U0_m_axi_gmem1_WDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal write_result_U0_m_axi_gmem1_WSTRB : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal write_result_U0_out_buf_address0 : STD_LOGIC_VECTOR (13 downto 0);
    signal write_result_U0_out_buf_ce0 : STD_LOGIC;
    ...
    component alveo_hls4ml_read_input IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component alveo_hls4ml_run_inference IS
    port (
        in_buf_address0 : OUT STD_LOGIC_VECTOR (13 downto 0);
        in_buf_ce0 : OUT STD_LOGIC;
        in_buf_d0 : OUT STD_LOGIC_VECTOR (287 downto 0);
    ...
    component alveo_hls4ml_write_result IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        i_address0 => run_inference_U0_out_buf_address0,
        i_ce0 => run_inference_U0_out_buf_ce0,
        i_we0 => run_inference_U0_out_buf_we0,
        i_d0 => run_inference_U0_out_buf_d0,
        i_q0 => out_buf_V_i_q0,
        t_address0 => write_result_U0_out_buf_address0,
        t_ce0 => write_result_U0_out_buf_ce0,
        t_we0 => ap_const_logic_0,
        ...
        i_write => run_inference_U0_ap_done,
    ...
    read_input_U0 : component alveo_hls4ml_read_input
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    run_inference_U0 : component alveo_hls4ml_run_inference
    port map (
        ...
        out_buf_address0 => run_inference_U0_out_buf_address0,
        out_buf_ce0 => run_inference_U0_out_buf_ce0,
        out_buf_d0 => run_inference_U0_out_buf_d0,
        out_buf_q0 => ap_const_lv16_0,
        out_buf_we0 => run_inference_U0_out_buf_we0,
        out_buf_address1 => run_inference_U0_out_buf_address1,
        out_buf_ce1 => run_inference_U0_out_buf_ce1,
        out_buf_d1 => run_inference_U0_out_buf_d1,
        out_buf_q1 => ap_const_lv16_0,
        out_buf_we1 => run_inference_U0_out_buf_we1,
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        in_buf_empty_n => ap_const_logic_0,
        in_buf_read => run_inference_U0_in_buf_read,
        out_buf_full_n => out_buf_V_i_full_n,
        out_buf_write => run_inference_U0_out_buf_write,
    ...
    write_result_U0 : component alveo_hls4ml_write_result
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ...
        out_buf_address0 => write_result_U0_out_buf_address0,
        out_buf_ce0 => write_result_U0_out_buf_ce0,
        out_buf_q0 => out_buf_V_t_q0);
    ...
    ap_done <= write_result_U0_ap_done;
    ap_idle <= (write_result_U0_ap_idle and run_inference_U0_ap_idle and read_input_U0_ap_idle and (out_buf_V_t_empty_n xor ap_const_logic_1) and (in_buf_V_t_empty_n xor ap_const_logic_1) and entry_proc_U0_ap_idle);
    ...
    run_inference_U0_ap_continue <= run_inference_U0_out_buf_full_n;
    run_inference_U0_ap_start <= in_buf_V_t_empty_n;
    run_inference_U0_out_buf_full_n <= out_buf_V_i_full_n;
    write_result_U0_ap_continue <= ap_continue;
    write_result_U0_ap_start <= out_buf_V_t_empty_n;
end behav;
