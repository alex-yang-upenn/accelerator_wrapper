...
entity alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_121_1 is
port (
...
architecture behav of alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_121_1 is 
...
attribute shreg_extract : string;
    ...
    component alveo_hls4ml_fifo_w48_d1024_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component alveo_hls4ml_fifo_w160_d1_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    input1_U : component alveo_hls4ml_fifo_w48_d1024_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    output2_U : component alveo_hls4ml_fifo_w160_d1_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
