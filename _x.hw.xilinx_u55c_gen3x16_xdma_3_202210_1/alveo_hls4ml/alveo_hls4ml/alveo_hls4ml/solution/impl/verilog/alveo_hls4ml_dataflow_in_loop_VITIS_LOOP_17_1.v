...
wire   [13:0] ereg_v1_U0_in_buf_address0;
wire    ereg_v1_U0_in_buf_ce0;
wire   [13:0] ereg_v1_U0_i;
wire   [13:0] ereg_v1_U0_out_buf_address0;
wire    ereg_v1_U0_out_buf_ce0;
wire    ereg_v1_U0_out_buf_we0;
wire   [15:0] ereg_v1_U0_out_buf_d0;
wire    ereg_v1_U0_in_buf_write;
wire    ereg_v1_U0_out_buf_write;
...
assign ereg_v1_U0_i = {{i[(14 - 15'd1):0]}};

assign ereg_v1_U0_in_buf_write = 1'b0;

assign ereg_v1_U0_out_buf_write = 1'b0;

assign in_buf_address0 = ereg_v1_U0_in_buf_address0;

assign in_buf_address1 = 14'd0;

assign in_buf_ce0 = ereg_v1_U0_in_buf_ce0;
...
assign in_buf_read = ereg_v1_U0_in_buf_write;

assign in_buf_we0 = 1'b0;

assign in_buf_we1 = 1'b0;

assign out_buf_address0 = ereg_v1_U0_out_buf_address0;

assign out_buf_address1 = 14'd0;

assign out_buf_ce0 = ereg_v1_U0_out_buf_ce0;

assign out_buf_ce1 = 1'b0;

assign out_buf_d0 = ereg_v1_U0_out_buf_d0;

assign out_buf_d1 = 16'd0;

assign out_buf_we0 = ereg_v1_U0_out_buf_we0;

assign out_buf_we1 = 1'b0;

assign out_buf_write = ereg_v1_U0_out_buf_write;
