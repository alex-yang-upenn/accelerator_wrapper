...
module alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_117_1 (
        m_axi_gmem0_AWVALID,
        m_axi_gmem0_AWREADY,
        m_axi_gmem0_AWADDR,
        m_axi_gmem0_AWID,
...
wire   [15:0] read_input_U0_input1_din;
...
wire   [15:0] myproject_U0_output_r_din;
...
wire    input1_full_n;
wire   [15:0] input1_dout;
wire   [3:0] input1_num_data_valid;
wire   [3:0] input1_fifo_cap;
wire    input1_empty_n;
wire    n_c_full_n;
wire   [12:0] n_c_dout;
...
alveo_hls4ml_fifo_w16_d8_S input1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
alveo_hls4ml_fifo_w16_d1_S output2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_117_1
