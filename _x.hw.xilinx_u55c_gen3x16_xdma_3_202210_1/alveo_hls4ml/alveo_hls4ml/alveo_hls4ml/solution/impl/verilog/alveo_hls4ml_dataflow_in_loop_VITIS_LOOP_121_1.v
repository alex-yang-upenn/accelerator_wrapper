...
module alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_121_1 (
        m_axi_gmem0_AWVALID,
        m_axi_gmem0_AWREADY,
        m_axi_gmem0_AWADDR,
        m_axi_gmem0_AWID,
...
alveo_hls4ml_fifo_w48_d1024_A input1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
alveo_hls4ml_fifo_w160_d1_S_x output2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_121_1
