    ...
    reg ap_done_reg_3;// for module run_inference_U0.dataflow_in_loop_VITIS_LOOP_17_1_U0.ereg_v1_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_3 <= 'b0;
        end
        else begin
            ap_done_reg_3 <= run_inference_U0.dataflow_in_loop_VITIS_LOOP_17_1_U0.ereg_v1_U0.ap_done & ~run_inference_U0.dataflow_in_loop_VITIS_LOOP_17_1_U0.ereg_v1_U0.ap_continue;
        end
    end
    ...
    assign proc_3_data_PIPO_blk[1] = 1'b0 | (~out_buf_V_U.t_empty_n & write_result_U0.ap_idle & ~out_buf_V_U.i_write);
