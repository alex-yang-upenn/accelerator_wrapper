    ...
    reg ap_done_reg_3;// for module VITIS_LOOP_59_3_proc_U0.dataflow_in_loop_VITIS_LOOP_59_3_U0.ereg_v1_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_3 <= 'b0;
        end
        else begin
            ap_done_reg_3 <= VITIS_LOOP_59_3_proc_U0.dataflow_in_loop_VITIS_LOOP_59_3_U0.ereg_v1_U0.ap_done & ~VITIS_LOOP_59_3_proc_U0.dataflow_in_loop_VITIS_LOOP_59_3_U0.ereg_v1_U0.ap_continue;
        end
    end
    ...
    alveo_hls4ml_hls_deadlock_detect_unit #(4, 0, 2, 2) alveo_hls4ml_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_PIPO_blk[1] = 1'b0 | (~out_buf_V_U.i_full_n & VITIS_LOOP_59_3_proc_U0.ap_done & ap_done_reg_1 & ~out_buf_V_U.t_read);
    ...
    assign proc_3_data_PIPO_blk[1] = 1'b0 | (~out_buf_V_U.t_empty_n & VITIS_LOOP_65_4_proc_U0.ap_idle & ~out_buf_V_U.i_write);
