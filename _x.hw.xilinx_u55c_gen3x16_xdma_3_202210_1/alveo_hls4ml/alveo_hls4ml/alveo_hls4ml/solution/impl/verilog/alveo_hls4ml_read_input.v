...
input  [63:0] in_r;
output  [255:0] input1_din;
input  [1:0] input1_num_data_valid;
input  [1:0] input1_fifo_cap;
input   input1_full_n;
output   input1_write;
input  [12:0] n;
output  [12:0] n_c_din;
...
reg    n_c_blk_n;
reg   [58:0] trunc_ln47_1_i_reg_143;
reg   [255:0] gmem0_addr_read_reg_154;
wire  signed [63:0] sext_ln47_fu_128_p1;
reg    ap_block_state1;
reg    ap_block_state73;
wire   [17:0] shl_ln_i_fu_100_p3;
wire   [63:0] zext_ln47_fu_108_p1;
wire   [63:0] add_ln47_fu_112_p2;
reg   [72:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((n_c_full_n == 1'b0) | (input1_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state73))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        trunc_ln47_1_i_reg_143 <= {{add_ln47_fu_112_p2[63:5]}};
    end
end
...
always @ (*) begin
    if (((n_c_full_n == 1'b0) | (input1_full_n == 1'b0))) begin
...
always @ (*) begin
    if ((~((n_c_full_n == 1'b0) | (input1_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state73))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign add_ln47_fu_112_p2 = (zext_ln47_fu_108_p1 + in_r);
...
always @ (*) begin
    ap_block_state73 = ((n_c_full_n == 1'b0) | (input1_full_n == 1'b0));
end

assign ap_ready = internal_ap_ready;

assign input1_din = gmem0_addr_read_reg_154;

assign m_axi_gmem0_ARADDR = sext_ln47_fu_128_p1;
...
assign sext_ln47_fu_128_p1 = $signed(trunc_ln47_1_i_reg_143);

assign shl_ln_i_fu_100_p3 = {{n}, {5'd0}};

assign start_out = real_start;

assign zext_ln47_fu_108_p1 = shl_ln_i_fu_100_p3;
