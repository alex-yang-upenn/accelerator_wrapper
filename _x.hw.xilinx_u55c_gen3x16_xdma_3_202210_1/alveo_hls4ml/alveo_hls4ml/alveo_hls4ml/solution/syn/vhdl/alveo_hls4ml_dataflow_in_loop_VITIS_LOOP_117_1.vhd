...
entity alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_117_1 is
port (
...
architecture behav of alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_117_1 is 
...
attribute shreg_extract : string;
    ...
    signal read_input_U0_input1_din : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal myproject_U0_output_r_din : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal input1_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal input1_num_data_valid : STD_LOGIC_VECTOR (3 downto 0);
    signal input1_fifo_cap : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal output2_dout : STD_LOGIC_VECTOR (15 downto 0);
    ...
    port (
        ...
        output_r_dout : IN STD_LOGIC_VECTOR (15 downto 0);
    ...
    component alveo_hls4ml_fifo_w16_d8_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component alveo_hls4ml_fifo_w16_d1_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    input1_U : component alveo_hls4ml_fifo_w16_d8_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    output2_U : component alveo_hls4ml_fifo_w16_d1_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
