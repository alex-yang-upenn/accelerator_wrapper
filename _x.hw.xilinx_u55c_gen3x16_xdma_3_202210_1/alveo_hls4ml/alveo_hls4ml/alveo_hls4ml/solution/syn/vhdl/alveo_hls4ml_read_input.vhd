...
port (
    ...
    input1_din : OUT STD_LOGIC_VECTOR (15 downto 0);
    input1_num_data_valid : IN STD_LOGIC_VECTOR (3 downto 0);
    input1_fifo_cap : IN STD_LOGIC_VECTOR (3 downto 0);
...
attribute shreg_extract : string;
    ...
    signal trunc_ln_i_reg_141 : STD_LOGIC_VECTOR (59 downto 0);
    signal gmem0_addr_read_reg_152 : STD_LOGIC_VECTOR (127 downto 0);
    signal grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start : STD_LOGIC;
    signal grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done : STD_LOGIC;
    signal grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_idle : STD_LOGIC;
    signal grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_ready : STD_LOGIC;
    signal grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_input1_din : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_input1_write : STD_LOGIC;
    signal grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state73 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state73 : signal is "none";
    signal ap_CS_fsm_state74 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state74 : signal is "none";
    signal sext_ln47_fu_131_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal shl_ln_i_fu_103_p3 : STD_LOGIC_VECTOR (16 downto 0);
    signal zext_ln47_fu_111_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln47_fu_115_p2 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component alveo_hls4ml_read_input_Pipeline_VITIS_LOOP_47_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        input1_full_n : IN STD_LOGIC;
        input1_write : OUT STD_LOGIC;
        gmem0_load_i : IN STD_LOGIC_VECTOR (127 downto 0) );
    end component;



begin
    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96 : component alveo_hls4ml_read_input_Pipeline_VITIS_LOOP_47_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start,
        ap_done => grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done,
        ap_idle => grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_idle,
        ap_ready => grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_ready,
        input1_din => grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_input1_din,
        input1_num_data_valid => ap_const_lv4_0,
        input1_fifo_cap => ap_const_lv4_0,
        input1_full_n => input1_full_n,
        input1_write => grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_input1_write,
        gmem0_load_i => gmem0_addr_read_reg_152);
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state74))) then 
    ...
    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state73)) then 
                    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_ready = ap_const_logic_1)) then 
                    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln_i_reg_141 <= add_ln47_fu_115_p2(63 downto 4);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_ARREADY, m_axi_gmem0_RVALID, n_c_full_n, ap_CS_fsm_state2, ap_CS_fsm_state72, grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done, ap_CS_fsm_state74)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state74 => 
                if (((grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state74))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state74;
                end if;
    ...
    add_ln47_fu_115_p2 <= std_logic_vector(unsigned(zext_ln47_fu_111_p1) + unsigned(in_r));
    ...
    ap_ST_fsm_state74_blk_assign_proc : process(grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done)
    begin
        if ((grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done = ap_const_logic_0)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done, ap_CS_fsm_state74)
    begin
        if (((grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state74))) then 
    ...
    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start <= grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg;
    input1_din <= grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_input1_din;

    input1_write_assign_proc : process(grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_input1_write, ap_CS_fsm_state74)
    begin
    ...
    internal_ap_ready_assign_proc : process(grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done, ap_CS_fsm_state74)
    begin
        if (((grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state74))) then 
    ...
    m_axi_gmem0_ARADDR <= sext_ln47_fu_131_p1;
    ...
    begin
        ...
        sext_ln47_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_i_reg_141),64));

    shl_ln_i_fu_103_p3 <= (n & ap_const_lv4_0);
    ...
    zext_ln47_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln_i_fu_103_p3),64));
end behav;
