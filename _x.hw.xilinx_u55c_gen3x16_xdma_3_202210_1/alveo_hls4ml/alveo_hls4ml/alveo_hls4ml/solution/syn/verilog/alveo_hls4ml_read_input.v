...
input  [63:0] in_r;
output  [15:0] input1_din;
input  [3:0] input1_num_data_valid;
input  [3:0] input1_fifo_cap;
input   input1_full_n;
output   input1_write;
input  [12:0] n;
output  [12:0] n_c_din;
...
reg    n_c_blk_n;
reg   [59:0] trunc_ln_i_reg_141;
reg   [127:0] gmem0_addr_read_reg_152;
wire    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start;
wire    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done;
wire    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_idle;
wire    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_ready;
wire   [15:0] grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_input1_din;
wire    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_input1_write;
reg    grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg;
wire    ap_CS_fsm_state73;
wire    ap_CS_fsm_state74;
wire  signed [63:0] sext_ln47_fu_131_p1;
reg    ap_block_state1;
wire   [16:0] shl_ln_i_fu_103_p3;
wire   [63:0] zext_ln47_fu_111_p1;
wire   [63:0] add_ln47_fu_115_p2;
reg   [73:0] ap_NS_fsm;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 74'd1;
#0 grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg = 1'b0;
end

alveo_hls4ml_read_input_Pipeline_VITIS_LOOP_47_1 grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .input1_num_data_valid(4'd0),
    .input1_fifo_cap(4'd0),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state74))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state73)) begin
            grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg <= 1'b1;
        end else if ((grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_ready == 1'b1)) begin
            grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        trunc_ln_i_reg_141 <= {{add_ln47_fu_115_p2[63:4]}};
    end
end
...
always @ (*) begin
    if ((grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state74))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign add_ln47_fu_115_p2 = (zext_ln47_fu_111_p1 + in_r);
...
assign grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start = grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_ap_start_reg;

assign input1_din = grp_read_input_Pipeline_VITIS_LOOP_47_1_fu_96_input1_din;

assign m_axi_gmem0_ARADDR = sext_ln47_fu_131_p1;
...
assign sext_ln47_fu_131_p1 = $signed(trunc_ln_i_reg_141);

assign shl_ln_i_fu_103_p3 = {{n}, {4'd0}};

assign start_out = real_start;

assign zext_ln47_fu_111_p1 = shl_ln_i_fu_103_p3;
