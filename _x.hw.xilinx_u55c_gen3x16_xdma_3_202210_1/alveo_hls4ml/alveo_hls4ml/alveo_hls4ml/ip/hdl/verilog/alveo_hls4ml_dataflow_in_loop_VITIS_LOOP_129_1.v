...
module alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_129_1 (
        m_axi_gmem0_AWVALID,
        m_axi_gmem0_AWREADY,
        m_axi_gmem0_AWADDR,
        m_axi_gmem0_AWID,
...
wire   [255:0] read_input_U0_input1_din;
...
wire   [79:0] myproject_U0_output_r_din;
...
wire    input1_full_n;
wire   [255:0] input1_dout;
wire   [1:0] input1_num_data_valid;
wire   [1:0] input1_fifo_cap;
wire    input1_empty_n;
wire    n_c_full_n;
wire   [12:0] n_c_dout;
...
alveo_hls4ml_fifo_w256_d1_S input1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
alveo_hls4ml_fifo_w13_d3_S n_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
alveo_hls4ml_fifo_w80_d1_S_x output2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
alveo_hls4ml_start_for_write_result_U0 start_for_write_result_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //alveo_hls4ml_dataflow_in_loop_VITIS_LOOP_129_1
